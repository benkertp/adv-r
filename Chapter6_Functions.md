...
-> prefix representation of infix function
...
## many are Primitives with formals(fun) -> NULL
## define these as NA
nargs2 <- as.numeric(lapply(funs, function(x) ifelse(is.primitive(x), NA, length(formals(x)))))

nargs2
table(nargs2, useNA="ifany")
